...
def recurrent_block_3d(input_tensor, filters, kernel_size=3, recur_num=1): #recur_num is changed to 1 from 2
    """
...
# Steps per epoch
steps_per_epoch = (len(train_img_list) // batch_size) // 2
val_steps_per_epoch = (len(val_img_list) // batch_size) // 2
